...
**Aviana Games - разработка игр под WebGL (Яндекс Игры) и Android**  
Разработчик игр на Unity | 12.2024 — 04.2026

- Полный цикл разработки игр по ТЗ — с нуля до готового к релизу продукта.
- Разработка игровых механик и развитие выпущенных проектов.
- Портирование WebGL-игр на Android и наоборот.
